...
export const configState = {
  ...
  // Use of System
  'indicator-category.use-of-system': {
    enabled: true,
  },
  'indicator.use-of-system.prandial-marking': {
    enabled: true,
    markedMeasurements: 3,
    percentDayThreshold: 50,
  },
  'indicator.use-of-system.insulin-carbohydrate-recording': {
    enabled: true,
    insulinOrCarbMeasurements: 3,
    percentDayThreshold: 75,
  },
  'indicator.use-of-system.download-frequency': {
    enabled: true,
    daysBetweenDownloads: 15,
  },
  ...
  'indicator.use-of-system.cartridge-frequency': {
    enabled: true,
    percentDayThreshold: 30,
  },

  // Treatment Adherence
  'indicator-category.treatment-adherence': {
    enabled: true,
  },
  'indicator.treatment-adherence.measurement-frequency': {
    enabled: true,
    dailyMeasurements: 4,
    maxPercentageOfMissedDays: 80,
  },
  'indicator.treatment-adherence.glycemic-control': {
    enabled: true,
    percentBolusThreshold: 20,
    minutesBeforeBolus: 30,
  },

...
export const convertStringToJSDate = dateString => new Date(dateString);
...
export const dateToFloat = date =>
  hourArrayReducer([date.hour, date.minute, date.second]);
...
export const convertGMTDateToFloat = date =>
  hourStringToFloat(toFormat('HH:mm:ss')(date));

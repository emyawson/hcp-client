...
import { colors, zIndexes, fontSize, spacing, boxShadows } from 'src/core';
...
.DayPicker_weekHeader_li {
  ...
  &:nth-child(1):before {
    content: "${translate('datePicker.dayLabels.sunday')}"
  }
  &:nth-child(2):before {
    content: "${translate('datePicker.dayLabels.monday')}";
  }
  &:nth-child(3):before {
    content: "${translate('datePicker.dayLabels.tuesday')}";
  }
  &:nth-child(4):before {
    content: "${translate('datePicker.dayLabels.wednesday')}";
  }
  &:nth-child(5):before {
    content: "${translate('datePicker.dayLabels.thursday')}";
  }
  &:nth-child(6):before {
    content: "${translate('datePicker.dayLabels.friday')}";
  }
  &:nth-child(7):before {
    content: "${translate('datePicker.dayLabels.saturday')}";
  }
}

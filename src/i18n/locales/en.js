  ...
  translations: {
    ...
    dashboard: {
      ...
      statusCard: {
        ...
        high: 'High',
        monthLabels: {
          daysMissing: 'days of information are missing',
          januaryShortForm: 'Jan',
          februaryShortForm: 'Feb',
          marchShortForm: 'Mar',
          aprilShortForm: 'Apr',
          mayShortForm: 'May',
          juneShortForm: 'Jun',
          julyShortForm: 'Jul',
          augustShortForm: 'Aug',
          septemberShortForm: 'Sep',
          octoberShortForm: 'Oct',
          novemberShortForm: 'Nov',
          decemberShortForm: 'Dec',
        },
      },
    },
    menu: {
    ...
    userDropdown: {
      managePatientProfile: 'Patient Profile',
    },
    searchBar: {
      name: 'Name',
      ...
      disclaimer: {
        ...
        meanBloodGlucose: {
          ...
          desc: `The mean blood glucose is calculated from the arithmetic mean of all blood glucose values. The status displayed is determined by the
            set thresholds under “Target Range”. These thresholds are also used when displaying the target range and hypo limit in the glucose graphs
            and  reports.`,
        },
        hiLoControlResult: {
    ...
    graphDetails: {
      ...
      legend: {
        ...
        bloodGlucoseWithMgPerDL: 'Blood glucose (mg/dL)',
        meanBloodGlucose: 'mean blood glucose',
    ...
    graphs: {
      ...
      insulin: {
        title: 'Basal / Bolus Info',
        basalBolusTitle: 'Basal / Bolus',
        basalRateChange: 'BASAL RATE CHANGE',
        bolus: 'Average Bolus',
        basalInsulin: 'Average Basal Insulin',
        totalInsulin: 'Average Total Insulin',
      ...
      iconTitles: {
        ...
        meal: 'Other Meal Time',
        hypoWarning: 'Hypo Warning',
        hyperWarning: 'Hyper Warning',
        bed: 'Bed Time',
        custom: 'Custom',
        beforeExercise: 'Before Exercise',
        DuringExercise: 'During Exercise',
        AfterExercise: 'After Exercise',
        userDefinedAsterisk: 'User defined Asterisk',
        stress: 'Stress',
        fasting: 'Fasting',
        illness: 'Illness',
      },
    ...
    prescription: {
      ...
      stripConsumption: {
        title: 'Strip Consumption',
      },
      patientStock: {
        label: 'Total Patient Stock',
        units: 'UDS',
      },
      frequency: {
      ...
      customClinicGuides: {
        ...
        historyHeader: 'Custom Clinic Guide History',
        remove: 'Remove',
        sortBy: 'Sort By',
        all: 'All',
        personal: 'Personal',
        ...
        modal: {
          title: 'Remove Custom Clinical Guide',
          unsuccessfulMessage: 'Unsuccessfully Removed',
          successfulMessage: 'Successfully Removed',
          cancel: 'Cancel',
          retry: 'Retry',
          ok: 'Ok',
          descLine1:
            'Removing this guide will make it unavailable for future patients.',
          descLine2:
            'Patients currently being treated with this guide will continue with these settings applied until it is changed.',
        },
      },
    },
    general: {
    ...
    orgStock: {
      ...
      addNewStock: {
        ...
        tubes: {
          label: 'Strip Containers Received',
        },
        strips: {
          label: 'Strips',
        },
    ...
    manufacturerInfo: {
      ...
      version: 'v',
      description: 'Diabetes Management Application Software',
      addressLine1: 'Roche Diabetes Care GmbH',
      addressLine2: 'Sandhofer Strasse 116',
      addressLine3: '68305 Mannheim',
      addressLine4: 'Gemany',
    },
    createPatient: {
      steps: {
        one: 'Step 1: Profile Type',
        two: 'Step 2: Patient Info',
        three: 'Step 3: Health Info',
        four: 'Step 4: Confirm',
        five: 'hello helper',
      },
      stepsLabels: {
      ...
      stepOne: {
        basic: {
          title: 'Basic',
          description:
            'We know that each patient has different needs. Now you can help to look after them individually.',
        },
        pickup: {
          title: 'Pick up at center',
          description:
            'Managing your patients’ diabetes has never been easier. Have strips delivered directly to your center where your patients can collect them.',
        },
        home: {
          title: 'Home Delivery',
          description:
            'Give your patients peace of mind. Patients don’t need to visit their center to collect strips. They’ll be delivered straight to their door.',
        },
      },
    },
    deviceAssignment: {
      ...
      serialNumber: 'S/N',
      steps: {
        one: 'Step 1: The device',
        two: 'Step 2: Assign patient to device',
        three: 'Step 3: Confirm',
      },
      confirmDevice: {
        title: 'The Device  ',
        header: 'Your selected device',
        deviceName: 'Device name',
        serialNumber: 'S/N',
        wrongDevice: 'Wrong Device?',
        tooltipText:
          'Try importing patient data, plug in the device to your computer and try again',
        proceedWithDevice: 'Proceed with device',
      },
      confirmAssignment: {
        title: 'Completed',
        assignedTo: 'successfully assigned to',
      ...
      confirmDeviceAssignment: {
        ...
        deviceSubheader: 'Your Selected Device',
        patientSubheader: 'Selected Patient',
        patientIdNumber: 'No.',
        dateOfBirth: 'DOB',
        confirmAssignDevice: 'Confirm Assign Device',

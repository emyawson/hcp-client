...
export interface GetIn {
  <O, K1 extends keyof O>(path: [K1], obj: O): O[K1];
  <O, K1 extends keyof O, K2 extends keyof O[K1]>(
    path: [K1, K2],
    obj: O,
  ): O[K1][K2];
...
export interface PathOr {
  <O, K1 extends keyof O>(defaultValue: O[K1], path: [K1], obj: O): O[K1];
  <O, K1 extends keyof O, K2 extends keyof O[K1]>(
    defaultValue: O[K1][K2],
    path: [K1, K2],
    obj: O,
  ): O[K1][K2];
  <O, K1 extends keyof O, K2 extends keyof O[K1], K3 extends keyof O[K1][K2]>(
    defaultValue: O[K1][K2][K3],
    path: [K1, K2, K3],
    obj: O,
  ): O[K1][K2][K3];
  <
